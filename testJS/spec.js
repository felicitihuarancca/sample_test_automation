        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a.apply(void 0, [_b.sent()]).toEqual('Super Calculator');
                        return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        goButton.click();
                        _a = expect;
                        return [4 /*yield*/, latestResult.getText()];
                    case 1:
                        _a.apply(void 0, [_b.sent()]).toEqual('3');
                        return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, latestResult.getText()];
                    case 1:
                        _a.apply(void 0, [_b.sent()]).toEqual('10');
                        return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        firstNumber.sendKeys(1);
                        _a = expect;
                        return [4 /*yield*/, firstNumber.getAttribute('value')];
                    case 1:
